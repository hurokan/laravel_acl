...
!function (d) {
    ...
    a.prototype.respChart = function (r, e, t, o) {
        ...
        if (0 < d("#bar-chart-example").length) {
            var t = {
                ...
                datasets: [{
                    ...
                    data: approved_property
                }, {
                    label: "Cancel Properties",
                    backgroundColor: s[1],
                    borderColor: s[1],
                    hoverBackgroundColor: s[1],
                    hoverBorderColor: s[1],
                    data: cancel_property
                }]
            };
        ...
        // <------------pic-chart for current month property enlistment --------->
        if (0 < d("#cur-month-enlistment").length) {
            var o = {
                labels: ["Rent", "Buy"],
                datasets: [{
                    data: enlistment_property,
                    backgroundColor: s = (i = d("#cur-month-enlistment").data("colors")) ? i.split(",") : r.concat(),
                    borderColor: "transparent"
                }]
            };
            a.push(this.respChart(d("#cur-month-enlistment"), "Pie", o,
                {maintainAspectRatio: !1,
                    legend: {display: 2}
                }))
        }

        // <------------pic-chart for current month sales status --------->
        if (0 < d("#cur_month_sale_status").length) {
            var o = {
                labels: ["Rent", "Buy"],
                datasets: [{
                    data: cur_month_sale_status,
                    backgroundColor: s = (i = d("#cur_month_sale_status").data("colors")) ? i.split(",") : r.concat(),
                    borderColor: "transparent"
                }]
            };
            a.push(this.respChart(d("#cur_month_sale_status"), "Pie", o,
                {maintainAspectRatio: !1,
                    legend: {display: 2}
                }))
        }
